    ...
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <form action="user/jobs.php" method="GET">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <?php if (!isLoggedIn()): ?>
                            <a href="user/login.php" class="btn btn-outline-primary" onclick="return confirm('กรุณาเข้าสู่ระบบก่อนดูตำแหน่งงาน')">ดูตำแหน่งงาน</a>
                        <?php else: ?>
                            <a href="user/jobs.php" class="btn btn-outline-primary">ดูตำแหน่งงาน</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <?php if (!isLoggedIn()): ?>
                            <a href="user/register.php" class="btn btn-outline-primary">สมัครสมาชิก</a>
                        <?php else: ?>
                            <a href="user/profile.php" class="btn btn-outline-primary">แก้ไขโปรไฟล์</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <?php if (!isLoggedIn()): ?>
                            <a href="user/login.php" class="btn btn-outline-primary">เข้าสู่ระบบ</a>
                        <?php else: ?>
                            <a href="user/my-applications.php" class="btn btn-outline-primary">ดูใบสมัครของฉัน</a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <?php if (!isLoggedIn()): ?>
                                            <a href="user/login.php" class="btn btn-sm btn-primary" onclick="return confirm('กรุณาเข้าสู่ระบบก่อนดูรายละเอียด')">ดูรายละเอียด</a>
                                        <?php else: ?>
                                            <a href="user/job-detail.php?id=<?php echo $job['id']; ?>" class="btn btn-sm btn-primary">ดูรายละเอียด</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
